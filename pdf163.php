...
//Queri untuk Menampilkan data
 ...
 $query = "select nobast,tglbast,pengembangbast,keterangan,nodokacuan, wilayah from bast b inner join (select distinct nobastaset, wilayah from dataaset)d on b.nobast=d.nobastaset inner join lokasidokumen l on b.nobast=l.nobastlokasi    where rekon163='1' order by wilayah asc";
...
$pdf->Cell(33,1,'DATA REKON KELOMPOK 163','LRTB',0,'C');
