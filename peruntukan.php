            ...
            <section class="col col-sm-12 col-md-12 col-lg-12">
              <div style=" overflow:auto;">
                ...
                <table class="table table-striped table bordered" >
                  ...
                  <?php
                    $qrPeruntukan="select * from peruntukan where nodokacuan='55/A/K/BKD/1979'";
                    ...
                    while($d3=mysql_fetch_array($queryP))
                    {
                        ...
                        <tr>
                          <td>
                            ...
                            <input type='hidden' name='nobast[]' value='$d3[nobast]'>
                          ...
                          <td>
                            <select name='idaset[]'>
                            ";
                              $qAset=mysql_query("select alamataset,kelurahan,nobastaset from dataaset where idaset='$d3[idaset]'");
                              $dAset=mysql_fetch_array($qAset);
                              echo"<option value='$d3[idaset]'>$dAset[alamataset] - $dAset[kelurahan] - $dAset[nobastaset]</option>";
                            $qBastAcuan=mysql_query("select nobast from bast where nodokacuan='$d3[nodokacuan]'");
                            $jAset=0;
                            $cAset='f';
                            while ($dBastAcuan=mysql_fetch_array($qBastAcuan)) 
                            {
                              $query=mysql_query("select idaset, alamataset, kelurahan from dataaset where nobastaset='$dBastAcuan[nobast]'");
                              if(mysql_num_rows($qBastAcuan)>1||mysql_num_rows($query)>1)
                          ...
                          <td>
                            <select name='statuslaporankeuangan[]'>
                          ...
                          <td>
                            <input type='text' name='tglsertifikat[]' value='$d3[tglsertifikat]'>
                          </td>
                          <td>
                          ...
                          <td>
                            <input type='text' name='tglsk[]' value='$d3[tglsk]'>
                          </td>
                          <td>
