  ...
  <div class="breadcrumb">
    ...
    <div class="latest">
        ...
        <div class="dashboard-content">
          ...
          <table>
            <tr>
              <td>Alamat lokasi</td><td>:</td><td><?php echo $data['alamataset']; ?></td>
            </tr>
	    <tr>
	      <td>Wilayah</td><td>:</td><td><?php echo $data['wilayah']; ?></td>
	    </tr>
	    <tr>
	      <td>Kecamatan</td><td>:</td><td><?php echo $data['kecamatan']; ?></td>
	    </tr>
	    <tr>
	      <td>Kelurahan</td><td>:</td><td><?php echo $data['kelurahan']; ?></td>
	    </tr>
	...
	include "koneksi.php";
	$id = $_GET['id'];
	$query2 = mysql_query("select * from dataaset d inner join peruntukan p on d.nobastaset=p.nobast  where nobastaset='$id'") or die(mysql_error());
