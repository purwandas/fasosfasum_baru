...
<?php
	...
	$query3 = mysql_query("select * from dataaset where wilayah='Jakarta Pusat' order by kecamatan asc") or die(mysql_error());
	while ($data3 = mysql_fetch_array($query3)){
	?>
	
	<tr>
	<td colspan="6" >Kecamatan : <?php echo $data3['kecamatan']; ?></td>
	</tr>
	<tr>
	<td colspan="6">Kelurahan : <?php echo $data3['kelurahan']; ?></td>
	</tr>
...
?>
	<tbody>  
		...
		<td class="left"><?php echo $data['pengembangbast']; ?></td>
        	...
        	<td class="right"><?php print number_format ($data['luas']); ?></td>
