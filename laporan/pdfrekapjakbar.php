...
<div align="center" ><span style="font-size: 18px; font-weight: bold">REKAPITULASI DATA BAST JAKARTA BARAT</span></div><br>
...
$query = mysql_query("select * from bast b inner join (select distinct nobastaset, wilayah from dataaset)a on a.nobastaset=b.nobast where wilayah='Jakarta Barat'");
	$no = 1;
