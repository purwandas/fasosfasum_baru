...
{
	$no++;
	$queryInsertKewajiban="INSERT INTO `kewajiban` (`idkewajiban`, `nodokacuan`, `deskripsi`, `jenisfasos`, `luas`, `pelunasan`) VALUES ('', '$dataPeruntukan[nodokacuan]', '$dataPeruntukan[deskripsi]', '$dataPeruntukan[jenisfasos]', '$dataPeruntukan[luas]', '$dataPeruntukan[luas]')";
