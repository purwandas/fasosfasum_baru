...
//Queri untuk Menampilkan data
 ...
 $query = "select nobast,tglbast,pengembangbast,keterangan,nodokacuan, wilayah from bast b inner join (select distinct nobastaset,wilayah from dataaset)d on b.nobast=d.nobastaset inner join lokasidokumen l on b.nobast=l.nobastlokasi    where mutasi='0' && bpk357 ='0' && pulomas='0' && tp3w='0' && dtr='1' order by wilayah asc";
...
$pdf->Cell(33,1,'DATA KELOMPOK DTR','LRTB',0,'C');
